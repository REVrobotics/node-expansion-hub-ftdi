...
exports.enterExpansionHubFirmwareUpdateMode = function (serial) { return __awaiter(void 0, void 0, void 0, function () {
    var addon;
    return __generator(this, function (_a) {
        try {
            addon = require('bindings')('addon.node');
            return [2 /*return*/, new Promise(function (resolve, reject) {
                    addon.enterExpansionHubFirmwareUpdateMode(serial, function (err) {
                        {
                            if (err) {
                                reject(err);
                            }
